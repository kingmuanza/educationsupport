...
<html>
    ...
    <body>
        <h1 class="titre">Liste des droits d'access</h1>
            ...
            <tbody>
                ...
                <tr class="pointeur" onclick="window.location.href='start#!/droitacces/${droitacces.iddroitAcces}'">
                    ...
                    <td>
                        <h4 class="ui image header">
                            <div class="content">
                                Crée le <fmt:formatDate value="${droitacces.created}" pattern="yyyy-MM-dd"/>
                                <div class="sub header">
                                    Modifié le <fmt:formatDate value="${droitacces.modified}" pattern="yyyy-MM-dd"/>
                                </div>
                            </div>
                        </h4>
                    </td>
                    ...
                    buttons: [
                        {
                            ...
                            action: function (e, dt, node, config) {
                                window.location.href='start#!/droitacces'
                            }
                        },
                        {
                            extend: 'excelHtml5',
