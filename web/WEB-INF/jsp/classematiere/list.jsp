...
<html>
    ...
    <body>
        <h1 class="titre">Liste des matières par classes</h1>
        ...
        <table id="dataTableUtilisateur" class="ui celled table responsive nowrap" style="width:100%">
            ...
            <tbody>
                <c:forEach items="${classesMatieres}" var="classe">
                <c:if test="${!classe.deleted}">    
                <tr class="pointeur" onclick="window.location.href='start#!/classematiere/${classematiere.idclassesMatieres}'">
                    <td>
                        <h4 class="ui image header">
                            <div class="content">
                                ${classe.salleDeClasseIdsalleDeClasse.code}</div>
                            </div>
                        </h4>
                    </td>
                    <td>
                        <h4 class="ui image header">
                            <div class="content">
                                ${classe.matiereIdmatiere.libelle}</div>
                            </div>
                        </h4>
                    </td>
                    <td>
                    ...
                    buttons: [
                        {
                            ...
                            action: function (e, dt, node, config) {
                                window.location.href='start#!/classematiere'
                            }
                        },
                        {
                            extend: 'excelHtml5',
