...
<html>
    ...
    <body>
        <h1 class="titre">Liste des conseils de disciplines</h1>
        ...
        <script>
            ...
            $(document).ready(function () {
                ...
                //ouvrirMenuCorrespondant("#section_params", "bouton_params", "conseildiscipline");
                    ...
                    buttons: [
                        {
                            ...
                            action: function (e, dt, node, config) {
                                window.location.href='start#!/conseildiscipline'
                            }
                        },
                        {
                            extend: 'excelHtml5',
