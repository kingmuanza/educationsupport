...
<html>
    ...
    <body>
        <h1 class="titre">Liste des autorisations de sorties</h1>
            ...
            <tbody>
                ...
                <tr class="pointeur" onclick="window.location.href='start#!/autorisationsortie/${autorisationsortie.idautorisationSortie}'">
                    ...
                    <td>
                        <h4 class="ui image header">
                            <div class="content">
                                ${autorisationsortie.employeIdemploye.individuIdindividu.noms}
                                <div class="sub header">
                                    ${autorisationsortie.employeIdemploye.individuIdindividu.prenoms}
                                </div>
                            </div>
                        </h4>
                    </td>
                    ...
                    <td>
                        <h4 class="ui image header">
                            <div class="content">
                                <fmt:formatDate value="${autorisationsortie.dateJour}" pattern="yyyy-MM-dd HH:mm:ss"/>
                            </div>
                        </h4>
                    </td>
                    <td>
                        <h4 class="ui image header">
                            <div class="content">
                                <fmt:formatDate value="${autorisationsortie.dateRetour}" pattern="yyyy-MM-dd HH:mm:ss"/>
                            </div>
                        </h4>
                    </td>
                </tr>
