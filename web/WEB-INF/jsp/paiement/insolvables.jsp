...
<html>
    ...
    <body>
        <h1 class="titre">Liste des insolvables</h1>
                ...
                <tr class="pointeur" onclick="window.location.href='start#!/eleve/${eleve.ideleve}'">
                    <td>
                        <h4 class="ui image header">
                            <div class="content">
                                ${eleve.individuIdindividu.noms}
                                <div class="sub header">
                                    ${eleve.individuIdindividu.prenoms}
                                </div>
                            </div>
                        </h4>
                    </td>
                    ...
                    <td>
                        <h4 class="ui image header">
                            <div class="content">
                                ${solvabiliteService.getMontantPaye(eleve)}</div>
                            </div>
                        </h4>
                    </td>
                    <td>
                        <h4 class="ui image header">
                            <div class="content">
                                ${solvabiliteService.getMontantRestant(eleve)}</div>
                            </div>
                        </h4>
                    </td>
                    <td>
                        <h4 class="ui image header">
                            <div class="content">
                                <c:choose>
                                    <c:when test="${empty eleve.moratoireCollection}">
                                        NON
                                    </c:when>
                                    <c:otherwise>
                                        OUI
                    ...
                    buttons: [
                        {
                            ...
                            action: function (e, dt, node, config) {
                                window.location.href='start#!/paiement'
                            }
                        },
                        {
                            extend: 'excelHtml5',
