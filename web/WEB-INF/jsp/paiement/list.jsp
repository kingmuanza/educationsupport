...
<html>
    ...
    <body>
        <h1 class="titre">Liste des paiements</h1>
                ...
                <tr class="pointeur" onclick="window.location.href='start#!/paiement/${paiement.idpaiement}'">
                    <td>
                        <h4 class="ui image header">
                            <div class="content">
                                ${paiement.eleveIdeleve.individuIdindividu.noms}
                                <div class="sub header">
                                    ${paiement.eleveIdeleve.individuIdindividu.prenoms}
                                </div>
                            </div>
                        </h4>
                    </td>
                    ...
                    <td>
                        <h4 class="ui image header">
                            <div class="content">
                                <fmt:formatDate value="${paiement.dateJour}" pattern="yyyy-MM-dd"/>
                            </div>
                        </h4>
                    </td>
                    <td>
