...
<html>
    ...
    <body>
        <h1 class="titre">Liste des series</h1>
        ...
        <table id="dataTableUtilisateur" class="ui celled table responsive nowrap" style="width:100%">
            ...
            <tbody>
                ...
                <c:if test="${!serie.deleted}">
                <tr class="pointeur" onclick="window.location.href='start#!/serie/${serie.idserie}'">
                    <td>
                    ...
                    <td>
                        <h4 class="ui image header">
                            <div class="content">
                                Crée le <fmt:formatDate value="${serie.created}" pattern="yyyy-MM-dd"/>
                                <div class="sub header">
                                    Modifié le <fmt:formatDate value="${serie.modified}" pattern="yyyy-MM-dd"/>
                                </div>
                            </div>
                        </h4>
                    </td>
        ...
        <script>
            ...
            $(document).ready(function () {
                ...
                //ouvrirMenuCorrespondant("#section_params", "bouton_params", "serie");
                    ...
                    buttons: [
                        {
                            ...
                            action: function (e, dt, node, config) {
                                window.location.href='start#!/serie'
                            }
                        },
                        {
                            extend: 'excelHtml5',
