...
<html>
    ...
    <body>
        <h1 class="titre">Liste des matières d'un enseignant dans une classe</h1>
        ...
        <table id="dataTableUtilisateur" class="ui celled table responsive nowrap" style="width:100%">
            ...
            <tbody>
                <c:forEach items="${enseignantsClassesMatieres}" var="enseignantclassematiere">
                <c:if test="${!enseignantclassematiere.deleted}">
                <tr class="pointeur" onclick="window.location.href='start#!/enseignantclassematiere/${enseignantClasseMatiere.idenseignantClasseMatiere}'">
                    <td>
                        <h4 class="ui image header">
                            <div class="content">
                                ${enseignantclassematiere.enseignantIdenseignant.individuIdindividu.noms}
                                <div class="sub header">
                                    ${enseignantclassematiere.enseignantIdenseignant.individuIdindividu.prenoms}
                                </div>
                            </div>
                        </h4>
                    </td>
                    <td>
                        <h4 class="ui image header">
                            <div class="content">
                                ${enseignantclassematiere.classesMatieresIdclassesMatieres.salleDeClasseIdsalleDeClasse.classeIdclasse.code}
                                <div class="sub header">
                                    ${enseignantclassematiere.classesMatieresIdclassesMatieres.salleDeClasseIdsalleDeClasse.serieIdserie.code}
                                </div>
                            </div>
                        </h4>
                    </td>
                    <td>
                        <h4 class="ui image header">
                            <div class="content">
                                ${enseignantclassematiere.classesMatieresIdclassesMatieres.matiereIdmatiere.code}
                                <div class="sub header">
                                    ${enseignantclassematiere.classesMatieresIdclassesMatieres.matiereIdmatiere.libelle}
                                </div>
                            </div>
                        </h4>
                    </td>
                    <td>
                        <h4 class="ui image header">
                            <div class="content">
                                Crée le <fmt:formatDate value="${enseignantclassematiere.created}" pattern="yyyy-MM-dd"/>
                                <div class="sub header">
                                    Modifié le <fmt:formatDate value="${enseignantclassematiere.modified}" pattern="yyyy-MM-dd"/>
                                </div>
                            </div>
                        </h4>
                    </td>
                    ...
                    buttons: [
                        {
                            ...
                            action: function (e, dt, node, config) {
                                window.location.href='start#!/enseignantclassematiere'
                            }
                        },
                        {
                            extend: 'excelHtml5',
